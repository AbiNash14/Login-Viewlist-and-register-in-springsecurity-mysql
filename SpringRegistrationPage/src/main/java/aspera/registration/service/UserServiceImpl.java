...
public class UserServiceImpl implements UserService {
    ...
    public User save(UserRegistrationDto registration) {
        ...
        user.setDestination(registration.getDestination());
        
        user.setLocation(registration.getLocation());
        
        user.setAccomodation(registration.getAccomodation());
        
        user.setPerson(registration.getPerson());
        
        user.setCheckin(registration.getCheckin());
        
        user.setCheckout(registration.getCheckout());
